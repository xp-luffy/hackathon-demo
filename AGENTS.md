...
Multi-branch clinic operations tool for staff to book appointments, manage patient records, track inventory, and run shift rotas — with role-based access and a live ops dashboard.
